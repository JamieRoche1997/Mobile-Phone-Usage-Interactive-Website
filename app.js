...
var usageRouter = require('./routes/usageRouter'); // the logic of usagerouter is provided in usagerouter
...
const url = 'mongodb://localhost:27017/UsageDatabase'; //needed for connecting the server to a localhost MongoDB at the default port and our database name is UsageDatabase
...
app.use('/usage', usageRouter); //use the usage router when there is a request at localhost:3000/usage
